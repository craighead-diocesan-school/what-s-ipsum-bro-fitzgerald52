...
<main>
  ...
  <div class="columns">
    <div class="text"><p>What's Ipsum Bro is a lorem ipsum generator with a twist. Instead of the same old boring lorem ipsum, you can choose from a variety of flavours to spice up your placeholder text.</p></div>
    <div class="boxes">
      <a href="pirate">
